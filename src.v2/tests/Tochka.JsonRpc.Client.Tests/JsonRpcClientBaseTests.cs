...
internal class JsonRpcClientBaseTests
{
    ...
    public void Setup()
    {
        ...
        var options = new TestOptions { Url = "http://foo.bar/" };
        clientMock = new Mock<JsonRpcClientBase>(handlerMock.ToHttpClient(), serializerMock.Object, new HeaderJsonRpcSerializer(), options, generatorMock.Object, Mock.Of<ILogger<JsonRpcClientBase>>())
        {
            CallBase = true
        };
    }
    ...
    [Test]
    public async Task Test_SendNotification1_ChainsToActualMethod()
    {
    ...
    [Test]
    public async Task Test_SendNotification2_ChainsToActualMethod()
    {
        var url = "test";
        var method = "method";
    ...
    [Test]
    public async Task Test_SendNotification3_ChainsToActualMethod()
    {
        var method = "method";
        var parameters = new object();
    ...
    [Test]
    public async Task Test_SendRequest1_ChainsToActualMethod()
    {
    ...
    [Test]
    public async Task Test_SendRequest2_ChainsToActualMethod()
    {
        var url = "test";
        var method = "method";
        var parameters = new object();
    ...
    [Test]
    public async Task Test_SendRequest3_ChainsToActualMethod()
    {
        var method = "method";
        var parameters = new object();
        var id = Mock.Of<IRpcId>();
    ...
    [Test]
    public async Task Test_SendRequest4_ChainsToActualMethod()
    {
        var url = "test";
        var method = "method";
        var parameters = new object();
    ...
    [Test]
    public async Task Test_SendRequest5_ChainsToActualMethod()
    {
        var method = "method";
        var parameters = new object();
        var id = Mock.Of<IRpcId>();
    ...
    [Test]
    public async Task Test_SendBatch_ChainsToActualMethod()
    {
    ...
    [Test]
    public async Task Test_Send_ChainsToActualMethod()
    {
        var request = new Request<object>();
