...
namespace Tochka.JsonRpc.Common.Old.Converters
{
    ...
    {
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer) => throw
        ...
        public override bool CanConvert(Type objectType) => objectType == typeof(IResponse);
    }
}
